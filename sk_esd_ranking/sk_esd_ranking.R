...
data_path <- "F:\\code\\code_back\\python_project\\data_picture_tool\\sk_esd_ranking\\test_data\\"
sk_esd_ranking_result_path <- 'F:\\code\\code_back\\python_project\\data_picture_tool\\sk_esd_ranking\\picture\\'
